...
namespace lansman.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly lansmanDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = lansmanConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(lansmanDbContext context)
        {
            _context = context;
        }
