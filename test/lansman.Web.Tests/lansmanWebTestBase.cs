...
{
    public abstract class lansmanWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static lansmanWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(lansmanWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<lansmanDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<lansmanDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<lansmanDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<lansmanDbContext, Task<T>> func)
        {
            T result;
